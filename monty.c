...
void
pop (stack_t **start, unsigned int i)
{
  stack_t *n;
  n = top;
  if (isEmpty (start))
...
void
topelement (stack_t **start, unsigned int i)
{
  if (isEmpty (start))
    {
